...
# Configuration Cowrie avec output vers Logstash
...
# =============================================================================
# OUTPUTS - CONFIGURATION MULTIPLE POUR ELK
# =============================================================================

# Output principal : JSON vers fichier (pour Filebeat)
[output_jsonlog]
logfile = var/log/cowrie/cowrie.json
epoch_timestamp = false

# Output vers Logstash TCP (redondance)
[output_logstash]
host = 192.168.2.124
port = 5046
timeout = 5
...
# Output vers fichier traditionnel (backup)
[output_textlog]
...
# Configuration Filebeat optimisée pour Cowrie
